      ...
      <Row>
        <Col span={10} style={{
          ...
          <Typography>
            ...
            <Paragraph>
              ...
              为什么能从一名普通员工成长为优秀员工?
            正如你说的那样：“<Text mark>每天都想着把每一件事做好，认真关注每一个细节</Text>”，承担责任，
            默默地为企业奉献。
            <Text strong>在此，我代表公司向你致以诚挚的谢意!感谢你对企业的认可和信赖!
            感谢你对企业的忠诚和敬业!感谢你为企业付出的辛劳和汗水!感谢你让自己的青春在公司闪光!</Text>。
          </Paragraph>
            <Paragraph>
        ...
        <Col span={14}>
          <BasicForm
            ...
            option={FormOption("王著名", "ng41454")}></BasicForm>
        </Col>
      </Row>
    </Fragment>
  );
